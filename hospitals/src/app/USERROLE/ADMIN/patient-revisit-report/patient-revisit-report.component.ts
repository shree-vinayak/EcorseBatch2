...
@Component({
  selector: 'app-patient-revisit-report',
  templateUrl: './patient-revisit-report.component.html',
  styleUrls: ['./patient-revisit-report.component.css']
})
export class PatientRevisitReportComponent implements OnInit {
  ...
  getDoctorWiseSummaryReport() {
    ...
    if (this.dateRangeForm.controls.endDate.value === "" || this.dateRangeForm.controls.endDate.value == null) {
      ...
      return this.http.post(environment.url + "revisit/doctor-wise-summary-for-revisit-patient", formData).subscribe((response: any) => {
  ...
  getAllPatientForDoctor(doctorname:string) {
    ...
    if (this.dateRangeForm.controls.endDate.value === "" || this.dateRangeForm.controls.endDate.value == null) {
      ...
      return this.http.post(environment.url + "revisit/revisit_patient-info-for-doctor", formData).subscribe((response: any) => {
