...
public class StudentService {
	...
	public  ResponseWrapper saveStudentInfo(StudentInfo studentInfo)
	{
		...
		else
		{
			...
			wrapper.setMessage("Can not create studentInfo, because student with this username is already available inside the database.");
	 ...
	 * 
	 * @param username
	 * @return  true if StudentInfo object is available inside the database for passed username otherwise return false 
	 */
	@Transactional
