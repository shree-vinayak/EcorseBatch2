	...
	public Object saveNewRegistration(@RequestBody NewRegistration obj) {
		...
		try {
			...
			if (i > 0) {
				...
				String aadhar = obj.getAadharnumber();
				String mobile = obj.getMobileno();
				if (aadhar == null || aadhar.equals("0") || aadhar.equals("")) {
					obj.setAadharnumber("NA");
				}
				if (mobile == null || mobile.equals("0") || mobile.equals("")) {
					obj.setMobileno("NA");
				}
